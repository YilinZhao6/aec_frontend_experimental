...
const InitialSearchMain = ({ 
  ...
  useEffect(() => {
    ...
    const handleDocumentClick = (e) => {
      // Only hide if click is outside both the search box and dashboard
      if (
    ...
    <div className="relative min-h-screen bg-terminal-white dark:bg-cyber-black transition-colors duration-300">
      ...
      <div className="fixed top-0 right-0 left-0 h-16 flex items-center justify-end px-6 z-10 sm:pr-6 sm:pl-20">
        ...
        <div className="flex items-center gap-6">
          {/* Logo with Text - Clean version */}
          <div className="hidden sm:flex items-center bg-terminal-light dark:bg-cyber-gray px-3 py-2 rounded-lg">
            <img 
