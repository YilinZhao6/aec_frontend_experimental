...
const InitialSearchMain = ({ 
  ...
  return (
    <div className="relative min-h-screen bg-terminal-white">
      {/* Desktop Navigation */}
      ...
      {/* Desktop Header */}
      <div className="hidden sm:flex fixed top-0 right-0 left-0 h-16 items-center justify-end px-6 z-10">
        <div className="flex items-center gap-6">
          <div className="flex items-center bg-terminal-light px-3 py-2 rounded-lg">
            <img 
      ...
      <div className="relative flex flex-col items-center justify-center min-h-screen px-4 sm:px-6 pt-16">
        <div className="w-full max-w-5xl space-y-8 sm:space-y-12">
          {/* Show TrendingSection only on desktop */}
          <div className="hidden sm:block">
            <TrendingSection />
          </div>
          ...
          <div className="relative animate-slide-up w-full">
            <div className="relative" ref={searchBoxRef}>
              <div className="text-box w-full h-12 sm:h-16 pl-14 pr-16 text-xl flex items-center">
          ...
          {/* Expandable Dashboard Section - This is where the expansion logic is fixed */}
          <div 
            ref={dashboardRef}
      ...
      {/* Show RightSideMenu only on desktop */}
      <div className="hidden sm:block">
        <RightSideMenu />
      </div>

      {/* WeChat Icon - show only on desktop */}
