...
const MarkdownViewerBase = ({ 
  ...
  // Determine whether to show the concept map and related topics
  // Only show for archive view or when generation is complete
    ...
    <div className="flex-1 flex h-full bg-[#F0F0F0] relative">
      <div className="sm:hidden fixed top-0 left-0 right-0 bg-[#F0F0F0] border-b border-[#CCCCCC] z-30">
        <div className="h-14 border-b border-[#CCCCCC] flex items-center justify-between px-4">
          <button
            onClick={onBackClick}
            className="p-2 hover:bg-terminal-light rounded-lg"
          >
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="px-3 py-1.5 bg-slate-300 text-gray-700 text-sm rounded-lg font-quicksand"
            >
              OUTLINE
            </button>
          </div>
