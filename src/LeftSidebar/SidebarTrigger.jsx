...
const SidebarTrigger = ({ 
  ...
  const isMarkdownPage = location.pathname.includes('/paper/') || location.pathname.includes('/archive/paper/');
  ...
  // Don't render on mobile for markdown pages
  if (isMarkdownPage && window.innerWidth < 640) {
    return null;
  }
