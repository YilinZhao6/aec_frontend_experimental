...
const UserInfoPage = () => {
  ...
  return (
    <div className="relative min-h-screen bg-white">
      ...
      {/* Mobile Header - Fixed */}
      <div className="fixed top-0 left-0 right-0 h-14 bg-white border-b border-gray-200 flex items-center px-4 z-30 sm:hidden">
        <button
          onClick={() => navigate(-1)}
      ...
      {/* Main Content */}
      <div className="pt-14 sm:pt-0 px-4 pb-6 max-w-4xl mx-auto">
        {/* Desktop Header */}
